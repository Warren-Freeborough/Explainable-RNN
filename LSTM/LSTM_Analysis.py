...
model.load_state_dict(torch.load("../Weights/LSTM.pt"))
model.eval()
...
plt.xlabel("Day") 
fig3.savefig('Results\\LSTM_Noise.pdf')
...
plt.xlabel("Day") 
fig4.savefig('Results\\LSTM_Noise_log.pdf')
...
fig5.savefig('Results\LSTM_Permutation.pdf')
